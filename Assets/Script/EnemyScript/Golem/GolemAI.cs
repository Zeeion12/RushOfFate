...
public class GolemAI : MonoBehaviour
{
    ...
    [SerializeField] private float patrolSpeed = 1.2f; // Slower than Bandit/Canine
    [SerializeField] private float patrolDistance = 5f;
    [SerializeField] private float idleTime = 2f; // Longer idle time

    [Header("Chase Settings")]
    [SerializeField] private float chaseSpeed = 2f; // Slower chase speed
    [SerializeField] private float detectionRange = 5f; // Slightly longer detection
    ...
    void Patrol()
    {
        ...
        // Set animation - Golem uses "isWalking" instead of "isRunning"
